...
class Ui_QueryHelpDialog(object):
    def setupUi(self, QueryHelpDialog):
        ...
        QueryHelpDialog.resize(652, 727)
...
"}")
    ...
    def retranslateUi(self, QueryHelpDialog):
        ...
        self.label_18.setText(QCoreApplication.translate("QueryHelpDialog", u"\\neg \U0001d719", None))
        ...
        self.label_25.setText(QCoreApplication.translate("QueryHelpDialog", u"\\hchop {\U0001d7191}{\U0001d7192}", None))
