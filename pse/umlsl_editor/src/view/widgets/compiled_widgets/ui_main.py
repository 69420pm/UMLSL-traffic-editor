...
"}")
        ...
        self.actionExport_to_MLSL_Simulation = QAction(MainWindow)
        self.actionExport_to_MLSL_Simulation.setObjectName(u"actionExport_to_MLSL_Simulation")
        self.actionImport_from_MLSL_Simulation = QAction(MainWindow)
        self.actionImport_from_MLSL_Simulation.setObjectName(u"actionImport_from_MLSL_Simulation")
        ...
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionExport_to_MLSL_Simulation)
        self.menuFile.addAction(self.actionImport_from_MLSL_Simulation)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionExport_to_MLSL_Simulation.setText(QCoreApplication.translate("MainWindow", u"Export to MLSL-Simulation", None))
        self.actionImport_from_MLSL_Simulation.setText(QCoreApplication.translate("MainWindow", u"Import from MLSL-Simulation", None))
