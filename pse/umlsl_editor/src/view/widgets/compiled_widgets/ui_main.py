...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionExport_to_MLSL_Simulation.setText(QCoreApplication.translate("MainWindow", u"Export to MLSL-Simulator", None))
        self.actionImport_from_MLSL_Simulation.setText(QCoreApplication.translate("MainWindow", u"Import from MLSL-Simulator", None))
