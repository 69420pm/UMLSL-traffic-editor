...
from pse.umlsl_editor.src.view.testing.sample_scene_generator import SampleDataController
...
def run_test_render() -> None:
    ...
    testDataController = SampleDataController()
    window = MainWindow(testDataController)
    sys.exit(app.exec())
