...
class TrafficSnapshotReader(ABC):
    """Interface for reading data out of the TrafficSnapshot. Use always this class to read data from the snapshot. NEVER access the data domain_models directly."""
