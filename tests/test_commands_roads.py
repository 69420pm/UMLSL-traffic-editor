...
from pse.umlsl_editor.src.commands.roads.add_road import AddRoadCommand
from pse.umlsl_editor.src.commands.roads.delete_road import DeleteRoad
from pse.umlsl_editor.src.commands.roads.edit_road import EditRoadCommand
...
class TestAddRoadCommand(unittest.TestCase):
    def test_execute_validates_and_adds_road(self):
        ...
        with patch(
            "pse.umlsl_editor.src.commands.roads.add_road.Road.from_params",
            autospec=True,
        ) as from_params:
